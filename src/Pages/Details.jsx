...
const Details = (props) => {
  const [details, setDetails] = useState([
    {
      ...
      img: "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEg8WmHTWqXuBHsK1s-FX4T9HclmyylKoncJiA0GHr3CxoH0sPTrv4pOC2GPwDdEUYymMLTkAXGw85W6QhtS6khHWwTitf9wUQP3KQbzkN7X73yrg53YDf9Lomc42slo4C0LgCjlSWP_YSEvOiazcxO0UaLx_-V0ScESmbCZGN0vn2b9RmcaSesl3jSjrA/s1423/Pathaan.png",
      category: "Bollywood",
      description:
  ...
  return (
    <div>
      <store.Provider value={[details, setDetails]}>{props.children}</store.Provider>
    </div>
  );
};
